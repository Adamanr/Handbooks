---
id: module-08-windows-functions
title: "Оконные функции: аналитика и ранжирование"
sidebar_label: "Оконные функции"
sidebar_position: 8
description: "Полное руководство по оконным функциям, аналитике и ранжированию"
...
:::tip Когда использовать ROW_NUMBER
...
:::info Разница между RANK и DENSE_RANK
...
:::warning LAST_VALUE и Frame Clause
